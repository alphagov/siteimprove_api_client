...
# Unit tests for SiteImproveApiClient::MobileViewport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::MobileViewport do
  let(:instance) { SiteImproveApiClient::MobileViewport.new }

  describe 'test an instance of MobileViewport' do
    it 'should create an instance of MobileViewport' do
      expect(instance).to be_instance_of(SiteImproveApiClient::MobileViewport)
    end
  end
