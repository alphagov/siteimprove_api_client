...
# Unit tests for SiteImproveApiClient::KeywordMonitoringKeyword
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::KeywordMonitoringKeyword do
  let(:instance) { SiteImproveApiClient::KeywordMonitoringKeyword.new }

  describe 'test an instance of KeywordMonitoringKeyword' do
    it 'should create an instance of KeywordMonitoringKeyword' do
      expect(instance).to be_instance_of(SiteImproveApiClient::KeywordMonitoringKeyword)
    end
  end
  ...
  describe 'test attribute "estimated_traffic"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "organic_competition"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["low", "medium", "high", "very_high"])
      # validator.allowable_values.each do |value|
      #   expect { instance.organic_competition = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "ranking_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "seo_page_score"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
