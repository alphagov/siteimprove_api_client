...
# Unit tests for SiteimproveAPIClient::MetaDescriptionTooLongInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::MetaDescriptionTooLongInfo do
  let(:instance) { SiteimproveAPIClient::MetaDescriptionTooLongInfo.new }

  describe 'test an instance of MetaDescriptionTooLongInfo' do
    it 'should create an instance of MetaDescriptionTooLongInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::MetaDescriptionTooLongInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_too_long_meta_description"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
