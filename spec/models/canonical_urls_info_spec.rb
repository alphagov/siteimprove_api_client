...
# Unit tests for SiteimproveAPIClient::CanonicalUrlsInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::CanonicalUrlsInfo do
  let(:instance) { SiteimproveAPIClient::CanonicalUrlsInfo.new }

  describe 'test an instance of CanonicalUrlsInfo' do
    it 'should create an instance of CanonicalUrlsInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::CanonicalUrlsInfo)
    end
  end
  describe 'test attribute "canonicals"' do
    it 'should work' do
