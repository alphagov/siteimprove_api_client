...
# Unit tests for SiteimproveAPIClient::PagesWithFramesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::PagesWithFramesInfo do
  let(:instance) { SiteimproveAPIClient::PagesWithFramesInfo.new }

  describe 'test an instance of PagesWithFramesInfo' do
    it 'should create an instance of PagesWithFramesInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::PagesWithFramesInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_frames"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
