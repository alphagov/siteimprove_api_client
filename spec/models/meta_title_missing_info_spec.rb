...
# Unit tests for SiteimproveAPIClient::MetaTitleMissingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::MetaTitleMissingInfo do
  let(:instance) { SiteimproveAPIClient::MetaTitleMissingInfo.new }

  describe 'test an instance of MetaTitleMissingInfo' do
    it 'should create an instance of MetaTitleMissingInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::MetaTitleMissingInfo)
    end
  end
  ...
  describe 'test attribute "pages_missing_meta_title"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
