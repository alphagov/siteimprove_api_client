...
# Unit tests for SiteimproveAPIClient::LinksStatusCode500Info
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::LinksStatusCode500Info do
  let(:instance) { SiteimproveAPIClient::LinksStatusCode500Info.new }

  describe 'test an instance of LinksStatusCode500Info' do
    it 'should create an instance of LinksStatusCode500Info' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::LinksStatusCode500Info)
    end
  end
  describe 'test attribute "_500_links"' do
    it 'should work' do
