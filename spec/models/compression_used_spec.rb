...
# Unit tests for SiteImproveAPIClient::CompressionUsed
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::CompressionUsed do
  let(:instance) { SiteImproveAPIClient::CompressionUsed.new }

  describe 'test an instance of CompressionUsed' do
    it 'should create an instance of CompressionUsed' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::CompressionUsed)
    end
  end
