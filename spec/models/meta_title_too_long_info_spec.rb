...
# Unit tests for SiteimproveAPIClient::MetaTitleTooLongInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::MetaTitleTooLongInfo do
  let(:instance) { SiteimproveAPIClient::MetaTitleTooLongInfo.new }

  describe 'test an instance of MetaTitleTooLongInfo' do
    it 'should create an instance of MetaTitleTooLongInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::MetaTitleTooLongInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_too_long_meta_title"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
