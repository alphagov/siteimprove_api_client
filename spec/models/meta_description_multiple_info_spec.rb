...
# Unit tests for SiteimproveAPIClient::MetaDescriptionMultipleInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::MetaDescriptionMultipleInfo do
  let(:instance) { SiteimproveAPIClient::MetaDescriptionMultipleInfo.new }

  describe 'test an instance of MetaDescriptionMultipleInfo' do
    it 'should create an instance of MetaDescriptionMultipleInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::MetaDescriptionMultipleInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_multiple_meta_descriptions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
