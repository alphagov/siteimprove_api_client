...
# Unit tests for SiteImproveApiClient::PagesWithMisspellingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::PagesWithMisspellingInfo do
  let(:instance) { SiteImproveApiClient::PagesWithMisspellingInfo.new }

  describe 'test an instance of PagesWithMisspellingInfo' do
    it 'should create an instance of PagesWithMisspellingInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::PagesWithMisspellingInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_misspellings"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
