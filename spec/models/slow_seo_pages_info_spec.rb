...
# Unit tests for SiteImproveAPIClient::SlowSeoPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::SlowSeoPagesInfo do
  let(:instance) { SiteImproveAPIClient::SlowSeoPagesInfo.new }

  describe 'test an instance of SlowSeoPagesInfo' do
    it 'should create an instance of SlowSeoPagesInfo' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::SlowSeoPagesInfo)
    end
  end
  ...
  describe 'test attribute "slow_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
