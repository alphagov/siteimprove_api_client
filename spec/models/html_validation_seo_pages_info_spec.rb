...
# Unit tests for SiteImproveApiClient::HtmlValidationSeoPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::HtmlValidationSeoPagesInfo do
  let(:instance) { SiteImproveApiClient::HtmlValidationSeoPagesInfo.new }

  describe 'test an instance of HtmlValidationSeoPagesInfo' do
    it 'should create an instance of HtmlValidationSeoPagesInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::HtmlValidationSeoPagesInfo)
    end
  end
  ...
  describe 'test attribute "invalid_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
