...
# Unit tests for SiteImproveApiClient::SitemapExist
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::SitemapExist do
  let(:instance) { SiteImproveApiClient::SitemapExist.new }

  describe 'test an instance of SitemapExist' do
    it 'should create an instance of SitemapExist' do
      expect(instance).to be_instance_of(SiteImproveApiClient::SitemapExist)
    end
  end
  ...
  describe 'test attribute "sitemap_exists"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
