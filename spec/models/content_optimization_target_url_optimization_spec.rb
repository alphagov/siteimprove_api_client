...
# Unit tests for SiteImproveAPIClient::ContentOptimizationTargetUrlOptimization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::ContentOptimizationTargetUrlOptimization do
  let(:instance) { SiteImproveAPIClient::ContentOptimizationTargetUrlOptimization.new }

  describe 'test an instance of ContentOptimizationTargetUrlOptimization' do
    it 'should create an instance of ContentOptimizationTargetUrlOptimization' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::ContentOptimizationTargetUrlOptimization)
    end
  end
  ...
  describe 'test attribute "h1_occurrences"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "h2_occurrences"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "h3_occurrences"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "meta_description_occurrences"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "title_occurrences"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
