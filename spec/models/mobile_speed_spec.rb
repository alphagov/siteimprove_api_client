...
# Unit tests for SiteImproveAPIClient::MobileSpeed
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::MobileSpeed do
  let(:instance) { SiteImproveAPIClient::MobileSpeed.new }

  describe 'test an instance of MobileSpeed' do
    it 'should create an instance of MobileSpeed' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::MobileSpeed)
    end
  end
