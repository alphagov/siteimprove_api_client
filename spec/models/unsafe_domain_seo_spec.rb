...
# Unit tests for SiteimproveAPIClient::UnsafeDomainSeo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::UnsafeDomainSeo do
  let(:instance) { SiteimproveAPIClient::UnsafeDomainSeo.new }

  describe 'test an instance of UnsafeDomainSeo' do
    it 'should create an instance of UnsafeDomainSeo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::UnsafeDomainSeo)
    end
  end
  ...
  describe 'test attribute "domain_is_safe"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
