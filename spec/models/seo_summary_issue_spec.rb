...
# Unit tests for SiteImproveAPIClient::SeoSummaryIssue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::SeoSummaryIssue do
  let(:instance) { SiteImproveAPIClient::SeoSummaryIssue.new }

  describe 'test an instance of SeoSummaryIssue' do
    it 'should create an instance of SeoSummaryIssue' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::SeoSummaryIssue)
    end
  end
