...
# Unit tests for SiteimproveAPIClient::MetaDescriptionEmptyInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::MetaDescriptionEmptyInfo do
  let(:instance) { SiteimproveAPIClient::MetaDescriptionEmptyInfo.new }

  describe 'test an instance of MetaDescriptionEmptyInfo' do
    it 'should create an instance of MetaDescriptionEmptyInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::MetaDescriptionEmptyInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_empty_meta_description"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
