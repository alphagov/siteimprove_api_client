...
# Unit tests for SiteimproveAPIClient::FontsizeLegibility
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::FontsizeLegibility do
  let(:instance) { SiteimproveAPIClient::FontsizeLegibility.new }

  describe 'test an instance of FontsizeLegibility' do
    it 'should create an instance of FontsizeLegibility' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::FontsizeLegibility)
    end
  end
