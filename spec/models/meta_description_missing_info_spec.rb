...
# Unit tests for SiteImproveApiClient::MetaDescriptionMissingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::MetaDescriptionMissingInfo do
  let(:instance) { SiteImproveApiClient::MetaDescriptionMissingInfo.new }

  describe 'test an instance of MetaDescriptionMissingInfo' do
    it 'should create an instance of MetaDescriptionMissingInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::MetaDescriptionMissingInfo)
    end
  end
  ...
  describe 'test attribute "pages_missing_meta_description"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
