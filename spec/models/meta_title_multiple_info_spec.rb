...
# Unit tests for SiteImproveApiClient::MetaTitleMultipleInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::MetaTitleMultipleInfo do
  let(:instance) { SiteImproveApiClient::MetaTitleMultipleInfo.new }

  describe 'test an instance of MetaTitleMultipleInfo' do
    it 'should create an instance of MetaTitleMultipleInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::MetaTitleMultipleInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_multiple_meta_titles"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
