...
# Unit tests for SiteimproveAPIClient::PagesWithLongUrlsInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::PagesWithLongUrlsInfo do
  let(:instance) { SiteimproveAPIClient::PagesWithLongUrlsInfo.new }

  describe 'test an instance of PagesWithLongUrlsInfo' do
    it 'should create an instance of PagesWithLongUrlsInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::PagesWithLongUrlsInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_long_urls"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
