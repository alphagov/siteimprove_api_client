...
# Unit tests for SiteImproveAPIClient::ManyInternalLinksInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::ManyInternalLinksInfo do
  let(:instance) { SiteImproveAPIClient::ManyInternalLinksInfo.new }

  describe 'test an instance of ManyInternalLinksInfo' do
    it 'should create an instance of ManyInternalLinksInfo' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::ManyInternalLinksInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_many_links"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
