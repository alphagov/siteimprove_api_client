...
# Unit tests for SiteimproveAPIClient::WordsPerPageInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::WordsPerPageInfo do
  let(:instance) { SiteimproveAPIClient::WordsPerPageInfo.new }

  describe 'test an instance of WordsPerPageInfo' do
    it 'should create an instance of WordsPerPageInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::WordsPerPageInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_less_than_500_words"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
