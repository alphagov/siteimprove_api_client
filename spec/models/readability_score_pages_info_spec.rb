...
# Unit tests for SiteImproveApiClient::ReadabilityScorePagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::ReadabilityScorePagesInfo do
  let(:instance) { SiteImproveApiClient::ReadabilityScorePagesInfo.new }

  describe 'test an instance of ReadabilityScorePagesInfo' do
    it 'should create an instance of ReadabilityScorePagesInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::ReadabilityScorePagesInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_low_score"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
