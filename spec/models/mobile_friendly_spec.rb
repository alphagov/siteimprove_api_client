...
# Unit tests for SiteImproveApiClient::MobileFriendly
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::MobileFriendly do
  let(:instance) { SiteImproveApiClient::MobileFriendly.new }

  describe 'test an instance of MobileFriendly' do
    it 'should create an instance of MobileFriendly' do
      expect(instance).to be_instance_of(SiteImproveApiClient::MobileFriendly)
    end
  end
