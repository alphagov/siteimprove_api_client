...
# Unit tests for SiteImproveApiClient::MetaTitleTooShortInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::MetaTitleTooShortInfo do
  let(:instance) { SiteImproveApiClient::MetaTitleTooShortInfo.new }

  describe 'test an instance of MetaTitleTooShortInfo' do
    it 'should create an instance of MetaTitleTooShortInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::MetaTitleTooShortInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_too_short_meta_title"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
