...
# Unit tests for SiteImproveApiClient::DesktopSpeed
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::DesktopSpeed do
  let(:instance) { SiteImproveApiClient::DesktopSpeed.new }

  describe 'test an instance of DesktopSpeed' do
    it 'should create an instance of DesktopSpeed' do
      expect(instance).to be_instance_of(SiteImproveApiClient::DesktopSpeed)
    end
  end
