...
# Unit tests for SiteImproveApiClient::H1MultipleInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::H1MultipleInfo do
  let(:instance) { SiteImproveApiClient::H1MultipleInfo.new }

  describe 'test an instance of H1MultipleInfo' do
    it 'should create an instance of H1MultipleInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::H1MultipleInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_multiple_h1s"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
