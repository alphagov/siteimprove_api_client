...
# Unit tests for SiteimproveAPIClient::PagesInSitemapInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::PagesInSitemapInfo do
  let(:instance) { SiteimproveAPIClient::PagesInSitemapInfo.new }

  describe 'test an instance of PagesInSitemapInfo' do
    it 'should create an instance of PagesInSitemapInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::PagesInSitemapInfo)
    end
  end
  ...
  describe 'test attribute "pages_in_sitemap"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "pages_not_in_sitemap"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
