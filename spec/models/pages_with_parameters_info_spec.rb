...
# Unit tests for SiteimproveAPIClient::PagesWithParametersInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::PagesWithParametersInfo do
  let(:instance) { SiteimproveAPIClient::PagesWithParametersInfo.new }

  describe 'test an instance of PagesWithParametersInfo' do
    it 'should create an instance of PagesWithParametersInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::PagesWithParametersInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_parameters"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
