...
# Unit tests for SiteimproveAPIClient::MisspellingsInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::MisspellingsInfo do
  let(:instance) { SiteimproveAPIClient::MisspellingsInfo.new }

  describe 'test an instance of MisspellingsInfo' do
    it 'should create an instance of MisspellingsInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::MisspellingsInfo)
    end
  end
