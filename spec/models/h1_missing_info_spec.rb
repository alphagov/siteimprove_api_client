...
# Unit tests for SiteimproveAPIClient::H1MissingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::H1MissingInfo do
  let(:instance) { SiteimproveAPIClient::H1MissingInfo.new }

  describe 'test an instance of H1MissingInfo' do
    it 'should create an instance of H1MissingInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::H1MissingInfo)
    end
  end
  ...
  describe 'test attribute "pages_without_h1"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
