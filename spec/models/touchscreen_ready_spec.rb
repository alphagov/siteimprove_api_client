...
# Unit tests for SiteImproveApiClient::TouchscreenReady
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::TouchscreenReady do
  let(:instance) { SiteImproveApiClient::TouchscreenReady.new }

  describe 'test an instance of TouchscreenReady' do
    it 'should create an instance of TouchscreenReady' do
      expect(instance).to be_instance_of(SiteImproveApiClient::TouchscreenReady)
    end
  end
