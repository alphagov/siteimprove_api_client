...
# Unit tests for SiteImproveApiClient::NoIndexPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::NoIndexPagesInfo do
  let(:instance) { SiteImproveApiClient::NoIndexPagesInfo.new }

  describe 'test an instance of NoIndexPagesInfo' do
    it 'should create an instance of NoIndexPagesInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::NoIndexPagesInfo)
    end
  end
  ...
  describe 'test attribute "no_index_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
