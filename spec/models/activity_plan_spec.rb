...
# Unit tests for SiteimproveAPIClient::ActivityPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::ActivityPlan do
  let(:instance) { SiteimproveAPIClient::ActivityPlan.new }

  describe 'test an instance of ActivityPlan' do
    it 'should create an instance of ActivityPlan' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::ActivityPlan)
    end
  end
  ...
  describe 'test attribute "activity_plan_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "default_database"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      ...
      #   expect { instance.default_database = value }.not_to raise_error
      # end
    end
  end
