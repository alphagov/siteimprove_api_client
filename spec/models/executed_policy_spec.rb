...
# Unit tests for SiteImproveApiClient::ExecutedPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::ExecutedPolicy do
  let(:instance) { SiteImproveApiClient::ExecutedPolicy.new }

  describe 'test an instance of ExecutedPolicy' do
    it 'should create an instance of ExecutedPolicy' do
      expect(instance).to be_instance_of(SiteImproveApiClient::ExecutedPolicy)
    end
  end
  ...
  describe 'test attribute "last_30_days_change_numerical"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "last_30_days_change_percentage"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "last_30_days_change_significance"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
