...
# Unit tests for SiteImproveAPIClient::SeoIssue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::SeoIssue do
  let(:instance) { SiteImproveAPIClient::SeoIssue.new }

  describe 'test an instance of SeoIssue' do
    it 'should create an instance of SeoIssue' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::SeoIssue)
    end
  end
