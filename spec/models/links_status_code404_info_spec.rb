...
# Unit tests for SiteImproveAPIClient::LinksStatusCode404Info
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::LinksStatusCode404Info do
  let(:instance) { SiteImproveAPIClient::LinksStatusCode404Info.new }

  describe 'test an instance of LinksStatusCode404Info' do
    it 'should create an instance of LinksStatusCode404Info' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::LinksStatusCode404Info)
    end
  end
