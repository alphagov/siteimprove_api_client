...
# Unit tests for SiteimproveAPIClient::ContentOptimizationTargetUrlKeyword
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::ContentOptimizationTargetUrlKeyword do
  let(:instance) { SiteimproveAPIClient::ContentOptimizationTargetUrlKeyword.new }

  describe 'test an instance of ContentOptimizationTargetUrlKeyword' do
    it 'should create an instance of ContentOptimizationTargetUrlKeyword' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::ContentOptimizationTargetUrlKeyword)
    end
  end
