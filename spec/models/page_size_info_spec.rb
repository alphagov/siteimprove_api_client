...
# Unit tests for SiteImproveApiClient::PageSizeInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::PageSizeInfo do
  let(:instance) { SiteImproveApiClient::PageSizeInfo.new }

  describe 'test an instance of PageSizeInfo' do
    it 'should create an instance of PageSizeInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::PageSizeInfo)
    end
  end
  ...
  describe 'test attribute "pages_over_1mb"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
