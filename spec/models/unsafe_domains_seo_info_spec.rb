...
# Unit tests for SiteimproveAPIClient::UnsafeDomainsSeoInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::UnsafeDomainsSeoInfo do
  let(:instance) { SiteimproveAPIClient::UnsafeDomainsSeoInfo.new }

  describe 'test an instance of UnsafeDomainsSeoInfo' do
    it 'should create an instance of UnsafeDomainsSeoInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::UnsafeDomainsSeoInfo)
    end
  end
  ...
  describe 'test attribute "unsafe_domain_links"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
