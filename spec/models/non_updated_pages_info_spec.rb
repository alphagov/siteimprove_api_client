...
# Unit tests for SiteImproveApiClient::NonUpdatedPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::NonUpdatedPagesInfo do
  let(:instance) { SiteImproveApiClient::NonUpdatedPagesInfo.new }

  describe 'test an instance of NonUpdatedPagesInfo' do
    it 'should create an instance of NonUpdatedPagesInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::NonUpdatedPagesInfo)
    end
  end
  ...
  describe 'test attribute "non_updated_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
