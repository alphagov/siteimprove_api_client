...
# Unit tests for SiteImproveAPIClient::SeoPageIssueDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::SeoPageIssueDetails do
  let(:instance) { SiteImproveAPIClient::SeoPageIssueDetails.new }

  describe 'test an instance of SeoPageIssueDetails' do
    it 'should create an instance of SeoPageIssueDetails' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::SeoPageIssueDetails)
    end
  end
