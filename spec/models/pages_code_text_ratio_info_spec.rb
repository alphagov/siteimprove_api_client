...
# Unit tests for SiteimproveAPIClient::PagesCodeTextRatioInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::PagesCodeTextRatioInfo do
  let(:instance) { SiteimproveAPIClient::PagesCodeTextRatioInfo.new }

  describe 'test an instance of PagesCodeTextRatioInfo' do
    it 'should create an instance of PagesCodeTextRatioInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::PagesCodeTextRatioInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_low_code_text_ratio"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
