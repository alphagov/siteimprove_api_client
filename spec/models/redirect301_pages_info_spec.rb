...
# Unit tests for SiteImproveAPIClient::Redirect301PagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::Redirect301PagesInfo do
  let(:instance) { SiteImproveAPIClient::Redirect301PagesInfo.new }

  describe 'test an instance of Redirect301PagesInfo' do
    it 'should create an instance of Redirect301PagesInfo' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::Redirect301PagesInfo)
    end
  end
  describe 'test attribute "_301_redirects"' do
    it 'should work' do
