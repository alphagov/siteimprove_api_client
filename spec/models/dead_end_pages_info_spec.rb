...
# Unit tests for SiteimproveAPIClient::DeadEndPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::DeadEndPagesInfo do
  let(:instance) { SiteimproveAPIClient::DeadEndPagesInfo.new }

  describe 'test an instance of DeadEndPagesInfo' do
    it 'should create an instance of DeadEndPagesInfo' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::DeadEndPagesInfo)
    end
  end
  ...
  describe 'test attribute "dead_end_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
