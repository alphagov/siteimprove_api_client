...
# Unit tests for SiteImproveApiClient::LinksStatusCode4xxInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::LinksStatusCode4xxInfo do
  let(:instance) { SiteImproveApiClient::LinksStatusCode4xxInfo.new }

  describe 'test an instance of LinksStatusCode4xxInfo' do
    it 'should create an instance of LinksStatusCode4xxInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::LinksStatusCode4xxInfo)
    end
  end
  describe 'test attribute "_4xx_links"' do
    it 'should work' do
