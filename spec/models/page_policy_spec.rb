...
# Unit tests for SiteimproveAPIClient::PagePolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteimproveAPIClient::PagePolicy do
  let(:instance) { SiteimproveAPIClient::PagePolicy.new }

  describe 'test an instance of PagePolicy' do
    it 'should create an instance of PagePolicy' do
      expect(instance).to be_instance_of(SiteimproveAPIClient::PagePolicy)
    end
  end
