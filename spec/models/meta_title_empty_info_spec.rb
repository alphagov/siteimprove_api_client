...
# Unit tests for SiteImproveApiClient::MetaTitleEmptyInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::MetaTitleEmptyInfo do
  let(:instance) { SiteImproveApiClient::MetaTitleEmptyInfo.new }

  describe 'test an instance of MetaTitleEmptyInfo' do
    it 'should create an instance of MetaTitleEmptyInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::MetaTitleEmptyInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_empty_meta_title"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
