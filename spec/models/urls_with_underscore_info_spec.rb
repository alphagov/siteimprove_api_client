...
# Unit tests for SiteImproveAPIClient::UrlsWithUnderscoreInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::UrlsWithUnderscoreInfo do
  let(:instance) { SiteImproveAPIClient::UrlsWithUnderscoreInfo.new }

  describe 'test an instance of UrlsWithUnderscoreInfo' do
    it 'should create an instance of UrlsWithUnderscoreInfo' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::UrlsWithUnderscoreInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_underscore"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
