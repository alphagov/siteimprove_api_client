...
# Unit tests for SiteImproveAPIClient::SslEnabledPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::SslEnabledPagesInfo do
  let(:instance) { SiteImproveAPIClient::SslEnabledPagesInfo.new }

  describe 'test an instance of SslEnabledPagesInfo' do
    it 'should create an instance of SslEnabledPagesInfo' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::SslEnabledPagesInfo)
    end
  end
  ...
  describe 'test attribute "non_ssl_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "ssl_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
