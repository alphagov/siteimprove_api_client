...
# Unit tests for SiteImproveApiClient::NoFollowPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::NoFollowPagesInfo do
  let(:instance) { SiteImproveApiClient::NoFollowPagesInfo.new }

  describe 'test an instance of NoFollowPagesInfo' do
    it 'should create an instance of NoFollowPagesInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::NoFollowPagesInfo)
    end
  end
  ...
  describe 'test attribute "no_follow_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
