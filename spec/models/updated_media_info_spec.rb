...
# Unit tests for SiteImproveApiClient::UpdatedMediaInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveApiClient::UpdatedMediaInfo do
  let(:instance) { SiteImproveApiClient::UpdatedMediaInfo.new }

  describe 'test an instance of UpdatedMediaInfo' do
    it 'should create an instance of UpdatedMediaInfo' do
      expect(instance).to be_instance_of(SiteImproveApiClient::UpdatedMediaInfo)
    end
  end
  ...
  describe 'test attribute "non_updated_media_files"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "total_media_files"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
