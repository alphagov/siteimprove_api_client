...
# Unit tests for SiteImproveAPIClient::OpenGraphTagsPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SiteImproveAPIClient::OpenGraphTagsPagesInfo do
  let(:instance) { SiteImproveAPIClient::OpenGraphTagsPagesInfo.new }

  describe 'test an instance of OpenGraphTagsPagesInfo' do
    it 'should create an instance of OpenGraphTagsPagesInfo' do
      expect(instance).to be_instance_of(SiteImproveAPIClient::OpenGraphTagsPagesInfo)
    end
  end
  ...
  describe 'test attribute "pages_with_tags"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "pages_without_tags"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
