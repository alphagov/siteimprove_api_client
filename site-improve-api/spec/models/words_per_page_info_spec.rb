...
# Unit tests for OpenapiClient::WordsPerPageInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WordsPerPageInfo do
  let(:instance) { OpenapiClient::WordsPerPageInfo.new }

  describe 'test an instance of WordsPerPageInfo' do
    it 'should create an instance of WordsPerPageInfo' do
      expect(instance).to be_instance_of(OpenapiClient::WordsPerPageInfo)
    end
  end
