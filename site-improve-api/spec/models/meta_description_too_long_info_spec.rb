...
# Unit tests for OpenapiClient::MetaDescriptionTooLongInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaDescriptionTooLongInfo do
  let(:instance) { OpenapiClient::MetaDescriptionTooLongInfo.new }

  describe 'test an instance of MetaDescriptionTooLongInfo' do
    it 'should create an instance of MetaDescriptionTooLongInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaDescriptionTooLongInfo)
    end
  end
