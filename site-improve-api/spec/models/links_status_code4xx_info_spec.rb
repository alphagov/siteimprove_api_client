...
# Unit tests for OpenapiClient::LinksStatusCode4xxInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LinksStatusCode4xxInfo do
  let(:instance) { OpenapiClient::LinksStatusCode4xxInfo.new }

  describe 'test an instance of LinksStatusCode4xxInfo' do
    it 'should create an instance of LinksStatusCode4xxInfo' do
      expect(instance).to be_instance_of(OpenapiClient::LinksStatusCode4xxInfo)
    end
  end
