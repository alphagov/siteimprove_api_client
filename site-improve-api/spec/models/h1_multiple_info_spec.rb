...
# Unit tests for OpenapiClient::H1MultipleInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::H1MultipleInfo do
  let(:instance) { OpenapiClient::H1MultipleInfo.new }

  describe 'test an instance of H1MultipleInfo' do
    it 'should create an instance of H1MultipleInfo' do
      expect(instance).to be_instance_of(OpenapiClient::H1MultipleInfo)
    end
  end
