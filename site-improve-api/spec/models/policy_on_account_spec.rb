...
# Unit tests for OpenapiClient::PolicyOnAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PolicyOnAccount do
  let(:instance) { OpenapiClient::PolicyOnAccount.new }

  describe 'test an instance of PolicyOnAccount' do
    it 'should create an instance of PolicyOnAccount' do
      expect(instance).to be_instance_of(OpenapiClient::PolicyOnAccount)
    end
  end
