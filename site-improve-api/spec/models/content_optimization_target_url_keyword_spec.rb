...
# Unit tests for OpenapiClient::ContentOptimizationTargetUrlKeyword
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ContentOptimizationTargetUrlKeyword do
  let(:instance) { OpenapiClient::ContentOptimizationTargetUrlKeyword.new }
  ...
  describe 'test an instance of ContentOptimizationTargetUrlKeyword' do
    it 'should create an instance of ContentOptimizationTargetUrlKeyword' do
      expect(instance).to be_instance_of(OpenapiClient::ContentOptimizationTargetUrlKeyword)
    end
  end
