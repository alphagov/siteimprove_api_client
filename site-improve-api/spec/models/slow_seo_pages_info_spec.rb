...
# Unit tests for OpenapiClient::SlowSeoPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SlowSeoPagesInfo do
  let(:instance) { OpenapiClient::SlowSeoPagesInfo.new }

  describe 'test an instance of SlowSeoPagesInfo' do
    it 'should create an instance of SlowSeoPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::SlowSeoPagesInfo)
    end
  end
