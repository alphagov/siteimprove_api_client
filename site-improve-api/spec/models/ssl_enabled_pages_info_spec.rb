...
# Unit tests for OpenapiClient::SslEnabledPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SslEnabledPagesInfo do
  let(:instance) { OpenapiClient::SslEnabledPagesInfo.new }

  describe 'test an instance of SslEnabledPagesInfo' do
    it 'should create an instance of SslEnabledPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::SslEnabledPagesInfo)
    end
  end
