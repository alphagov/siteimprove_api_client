...
# Unit tests for OpenapiClient::H1EmptyInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::H1EmptyInfo do
  let(:instance) { OpenapiClient::H1EmptyInfo.new }

  describe 'test an instance of H1EmptyInfo' do
    it 'should create an instance of H1EmptyInfo' do
      expect(instance).to be_instance_of(OpenapiClient::H1EmptyInfo)
    end
  end
