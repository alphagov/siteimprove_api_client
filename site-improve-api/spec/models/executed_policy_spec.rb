...
# Unit tests for OpenapiClient::ExecutedPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ExecutedPolicy do
  let(:instance) { OpenapiClient::ExecutedPolicy.new }

  describe 'test an instance of ExecutedPolicy' do
    it 'should create an instance of ExecutedPolicy' do
      expect(instance).to be_instance_of(OpenapiClient::ExecutedPolicy)
    end
  end
