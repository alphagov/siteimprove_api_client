...
# Unit tests for OpenapiClient::ReadabilityScorePagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReadabilityScorePagesInfo do
  let(:instance) { OpenapiClient::ReadabilityScorePagesInfo.new }

  describe 'test an instance of ReadabilityScorePagesInfo' do
    it 'should create an instance of ReadabilityScorePagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::ReadabilityScorePagesInfo)
    end
  end
