...
# Unit tests for OpenapiClient::PagesWithLongUrlsInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagesWithLongUrlsInfo do
  let(:instance) { OpenapiClient::PagesWithLongUrlsInfo.new }

  describe 'test an instance of PagesWithLongUrlsInfo' do
    it 'should create an instance of PagesWithLongUrlsInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PagesWithLongUrlsInfo)
    end
  end
