...
# Unit tests for OpenapiClient::RedirectChainPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RedirectChainPagesInfo do
  let(:instance) { OpenapiClient::RedirectChainPagesInfo.new }

  describe 'test an instance of RedirectChainPagesInfo' do
    it 'should create an instance of RedirectChainPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::RedirectChainPagesInfo)
    end
  end
