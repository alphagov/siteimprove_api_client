...
# Unit tests for OpenapiClient::ActivityPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ActivityPlan do
  let(:instance) { OpenapiClient::ActivityPlan.new }

  describe 'test an instance of ActivityPlan' do
    it 'should create an instance of ActivityPlan' do
      expect(instance).to be_instance_of(OpenapiClient::ActivityPlan)
    end
  end
