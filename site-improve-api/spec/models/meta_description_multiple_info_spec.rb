...
# Unit tests for OpenapiClient::MetaDescriptionMultipleInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaDescriptionMultipleInfo do
  let(:instance) { OpenapiClient::MetaDescriptionMultipleInfo.new }
  ...
  describe 'test an instance of MetaDescriptionMultipleInfo' do
    it 'should create an instance of MetaDescriptionMultipleInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaDescriptionMultipleInfo)
    end
  end
