...
# Unit tests for OpenapiClient::UnsafeDomainSeo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UnsafeDomainSeo do
  let(:instance) { OpenapiClient::UnsafeDomainSeo.new }

  describe 'test an instance of UnsafeDomainSeo' do
    it 'should create an instance of UnsafeDomainSeo' do
      expect(instance).to be_instance_of(OpenapiClient::UnsafeDomainSeo)
    end
  end
