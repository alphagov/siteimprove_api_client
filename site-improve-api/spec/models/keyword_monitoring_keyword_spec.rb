...
# Unit tests for OpenapiClient::KeywordMonitoringKeyword
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::KeywordMonitoringKeyword do
  let(:instance) { OpenapiClient::KeywordMonitoringKeyword.new }

  describe 'test an instance of KeywordMonitoringKeyword' do
    it 'should create an instance of KeywordMonitoringKeyword' do
      expect(instance).to be_instance_of(OpenapiClient::KeywordMonitoringKeyword)
    end
  end
