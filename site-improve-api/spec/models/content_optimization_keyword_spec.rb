...
# Unit tests for OpenapiClient::ContentOptimizationKeyword
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ContentOptimizationKeyword do
  let(:instance) { OpenapiClient::ContentOptimizationKeyword.new }

  describe 'test an instance of ContentOptimizationKeyword' do
    it 'should create an instance of ContentOptimizationKeyword' do
      expect(instance).to be_instance_of(OpenapiClient::ContentOptimizationKeyword)
    end
  end
