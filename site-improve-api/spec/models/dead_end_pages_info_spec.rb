...
# Unit tests for OpenapiClient::DeadEndPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeadEndPagesInfo do
  let(:instance) { OpenapiClient::DeadEndPagesInfo.new }

  describe 'test an instance of DeadEndPagesInfo' do
    it 'should create an instance of DeadEndPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::DeadEndPagesInfo)
    end
  end
