...
# Unit tests for OpenapiClient::PageIssue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageIssue do
  let(:instance) { OpenapiClient::PageIssue.new }

  describe 'test an instance of PageIssue' do
    it 'should create an instance of PageIssue' do
      expect(instance).to be_instance_of(OpenapiClient::PageIssue)
    end
  end
