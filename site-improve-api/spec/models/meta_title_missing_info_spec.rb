...
# Unit tests for OpenapiClient::MetaTitleMissingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaTitleMissingInfo do
  let(:instance) { OpenapiClient::MetaTitleMissingInfo.new }

  describe 'test an instance of MetaTitleMissingInfo' do
    it 'should create an instance of MetaTitleMissingInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaTitleMissingInfo)
    end
  end
