...
# Unit tests for OpenapiClient::CompressionUsed
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CompressionUsed do
  let(:instance) { OpenapiClient::CompressionUsed.new }

  describe 'test an instance of CompressionUsed' do
    it 'should create an instance of CompressionUsed' do
      expect(instance).to be_instance_of(OpenapiClient::CompressionUsed)
    end
  end
