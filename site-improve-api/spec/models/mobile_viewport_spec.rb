...
# Unit tests for OpenapiClient::MobileViewport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MobileViewport do
  let(:instance) { OpenapiClient::MobileViewport.new }

  describe 'test an instance of MobileViewport' do
    it 'should create an instance of MobileViewport' do
      expect(instance).to be_instance_of(OpenapiClient::MobileViewport)
    end
  end
