...
# Unit tests for OpenapiClient::HtmlValidationSeoPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HtmlValidationSeoPagesInfo do
  let(:instance) { OpenapiClient::HtmlValidationSeoPagesInfo.new }

  describe 'test an instance of HtmlValidationSeoPagesInfo' do
    it 'should create an instance of HtmlValidationSeoPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::HtmlValidationSeoPagesInfo)
    end
  end
