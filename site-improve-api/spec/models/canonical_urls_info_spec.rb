...
# Unit tests for OpenapiClient::CanonicalUrlsInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CanonicalUrlsInfo do
  let(:instance) { OpenapiClient::CanonicalUrlsInfo.new }

  describe 'test an instance of CanonicalUrlsInfo' do
    it 'should create an instance of CanonicalUrlsInfo' do
      expect(instance).to be_instance_of(OpenapiClient::CanonicalUrlsInfo)
    end
  end
