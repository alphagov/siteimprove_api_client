...
# Unit tests for OpenapiClient::CssValidationErrorInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CssValidationErrorInfo do
  let(:instance) { OpenapiClient::CssValidationErrorInfo.new }

  describe 'test an instance of CssValidationErrorInfo' do
    it 'should create an instance of CssValidationErrorInfo' do
      expect(instance).to be_instance_of(OpenapiClient::CssValidationErrorInfo)
    end
  end
