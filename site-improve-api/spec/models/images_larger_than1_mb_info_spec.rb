...
# Unit tests for OpenapiClient::ImagesLargerThan1MbInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ImagesLargerThan1MbInfo do
  let(:instance) { OpenapiClient::ImagesLargerThan1MbInfo.new }

  describe 'test an instance of ImagesLargerThan1MbInfo' do
    it 'should create an instance of ImagesLargerThan1MbInfo' do
      expect(instance).to be_instance_of(OpenapiClient::ImagesLargerThan1MbInfo)
    end
  end
