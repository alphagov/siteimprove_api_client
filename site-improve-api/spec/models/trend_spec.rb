...
# Unit tests for OpenapiClient::Trend
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Trend do
  let(:instance) { OpenapiClient::Trend.new }

  describe 'test an instance of Trend' do
    it 'should create an instance of Trend' do
      expect(instance).to be_instance_of(OpenapiClient::Trend)
    end
  end
