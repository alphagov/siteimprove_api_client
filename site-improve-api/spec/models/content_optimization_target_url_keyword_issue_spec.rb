...
# Unit tests for OpenapiClient::ContentOptimizationTargetUrlKeywordIssue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ContentOptimizationTargetUrlKeywordIssue do
  let(:instance) { OpenapiClient::ContentOptimizationTargetUrlKeywordIssue.new }
  ...
  describe 'test an instance of ContentOptimizationTargetUrlKeywordIssue' do
    it 'should create an instance of ContentOptimizationTargetUrlKeywordIssue' do
      expect(instance).to be_instance_of(OpenapiClient::ContentOptimizationTargetUrlKeywordIssue)
    end
  end
