...
# Unit tests for OpenapiClient::SeoPageIssueDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SeoPageIssueDetails do
  let(:instance) { OpenapiClient::SeoPageIssueDetails.new }

  describe 'test an instance of SeoPageIssueDetails' do
    it 'should create an instance of SeoPageIssueDetails' do
      expect(instance).to be_instance_of(OpenapiClient::SeoPageIssueDetails)
    end
  end
