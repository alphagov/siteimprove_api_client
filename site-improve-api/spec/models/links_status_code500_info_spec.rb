...
# Unit tests for OpenapiClient::LinksStatusCode500Info
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LinksStatusCode500Info do
  let(:instance) { OpenapiClient::LinksStatusCode500Info.new }

  describe 'test an instance of LinksStatusCode500Info' do
    it 'should create an instance of LinksStatusCode500Info' do
      expect(instance).to be_instance_of(OpenapiClient::LinksStatusCode500Info)
    end
  end
