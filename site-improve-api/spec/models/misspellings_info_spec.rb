...
# Unit tests for OpenapiClient::MisspellingsInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MisspellingsInfo do
  let(:instance) { OpenapiClient::MisspellingsInfo.new }

  describe 'test an instance of MisspellingsInfo' do
    it 'should create an instance of MisspellingsInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MisspellingsInfo)
    end
  end
