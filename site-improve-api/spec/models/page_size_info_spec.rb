...
# Unit tests for OpenapiClient::PageSizeInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageSizeInfo do
  let(:instance) { OpenapiClient::PageSizeInfo.new }

  describe 'test an instance of PageSizeInfo' do
    it 'should create an instance of PageSizeInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PageSizeInfo)
    end
  end
