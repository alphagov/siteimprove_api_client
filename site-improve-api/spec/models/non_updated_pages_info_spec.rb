...
# Unit tests for OpenapiClient::NonUpdatedPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NonUpdatedPagesInfo do
  let(:instance) { OpenapiClient::NonUpdatedPagesInfo.new }

  describe 'test an instance of NonUpdatedPagesInfo' do
    it 'should create an instance of NonUpdatedPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::NonUpdatedPagesInfo)
    end
  end
