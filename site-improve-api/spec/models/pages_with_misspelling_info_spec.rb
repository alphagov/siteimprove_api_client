...
# Unit tests for OpenapiClient::PagesWithMisspellingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagesWithMisspellingInfo do
  let(:instance) { OpenapiClient::PagesWithMisspellingInfo.new }

  describe 'test an instance of PagesWithMisspellingInfo' do
    it 'should create an instance of PagesWithMisspellingInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PagesWithMisspellingInfo)
    end
  end
