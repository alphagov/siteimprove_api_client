...
# Unit tests for OpenapiClient::PagesWithHighNavigationDepthInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagesWithHighNavigationDepthInfo do
  let(:instance) { OpenapiClient::PagesWithHighNavigationDepthInfo.new }
  ...
  describe 'test an instance of PagesWithHighNavigationDepthInfo' do
    it 'should create an instance of PagesWithHighNavigationDepthInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PagesWithHighNavigationDepthInfo)
    end
  end
