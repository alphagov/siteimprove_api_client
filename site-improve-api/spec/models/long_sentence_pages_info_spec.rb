...
# Unit tests for OpenapiClient::LongSentencePagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LongSentencePagesInfo do
  let(:instance) { OpenapiClient::LongSentencePagesInfo.new }

  describe 'test an instance of LongSentencePagesInfo' do
    it 'should create an instance of LongSentencePagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::LongSentencePagesInfo)
    end
  end
