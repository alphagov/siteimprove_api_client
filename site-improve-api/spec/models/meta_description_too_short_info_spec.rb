...
# Unit tests for OpenapiClient::MetaDescriptionTooShortInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaDescriptionTooShortInfo do
  let(:instance) { OpenapiClient::MetaDescriptionTooShortInfo.new }
  ...
  describe 'test an instance of MetaDescriptionTooShortInfo' do
    it 'should create an instance of MetaDescriptionTooShortInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaDescriptionTooShortInfo)
    end
  end
