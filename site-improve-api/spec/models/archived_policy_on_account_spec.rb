...
# Unit tests for OpenapiClient::ArchivedPolicyOnAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ArchivedPolicyOnAccount do
  let(:instance) { OpenapiClient::ArchivedPolicyOnAccount.new }

  describe 'test an instance of ArchivedPolicyOnAccount' do
    it 'should create an instance of ArchivedPolicyOnAccount' do
      expect(instance).to be_instance_of(OpenapiClient::ArchivedPolicyOnAccount)
    end
  end
