...
# Unit tests for OpenapiClient::ContentOptimizationTargetUrlCompetingContent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ContentOptimizationTargetUrlCompetingContent do
  let(:instance) { OpenapiClient::ContentOptimizationTargetUrlCompetingContent.new }
  ...
  describe 'test an instance of ContentOptimizationTargetUrlCompetingContent' do
    it 'should create an instance of ContentOptimizationTargetUrlCompetingContent' do
      expect(instance).to be_instance_of(OpenapiClient::ContentOptimizationTargetUrlCompetingContent)
    end
  end
