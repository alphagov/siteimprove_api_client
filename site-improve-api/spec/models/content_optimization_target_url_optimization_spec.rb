...
# Unit tests for OpenapiClient::ContentOptimizationTargetUrlOptimization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ContentOptimizationTargetUrlOptimization do
  let(:instance) { OpenapiClient::ContentOptimizationTargetUrlOptimization.new }
  ...
  describe 'test an instance of ContentOptimizationTargetUrlOptimization' do
    it 'should create an instance of ContentOptimizationTargetUrlOptimization' do
      expect(instance).to be_instance_of(OpenapiClient::ContentOptimizationTargetUrlOptimization)
    end
  end
