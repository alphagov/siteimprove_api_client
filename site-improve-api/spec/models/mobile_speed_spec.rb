...
# Unit tests for OpenapiClient::MobileSpeed
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MobileSpeed do
  let(:instance) { OpenapiClient::MobileSpeed.new }

  describe 'test an instance of MobileSpeed' do
    it 'should create an instance of MobileSpeed' do
      expect(instance).to be_instance_of(OpenapiClient::MobileSpeed)
    end
  end
