...
# Unit tests for OpenapiClient::MetaTitleTooLongInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaTitleTooLongInfo do
  let(:instance) { OpenapiClient::MetaTitleTooLongInfo.new }

  describe 'test an instance of MetaTitleTooLongInfo' do
    it 'should create an instance of MetaTitleTooLongInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaTitleTooLongInfo)
    end
  end
