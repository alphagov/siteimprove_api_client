...
# Unit tests for OpenapiClient::PagesInSitemapInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagesInSitemapInfo do
  let(:instance) { OpenapiClient::PagesInSitemapInfo.new }

  describe 'test an instance of PagesInSitemapInfo' do
    it 'should create an instance of PagesInSitemapInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PagesInSitemapInfo)
    end
  end
