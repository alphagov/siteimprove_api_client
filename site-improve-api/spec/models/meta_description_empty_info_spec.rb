...
# Unit tests for OpenapiClient::MetaDescriptionEmptyInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaDescriptionEmptyInfo do
  let(:instance) { OpenapiClient::MetaDescriptionEmptyInfo.new }

  describe 'test an instance of MetaDescriptionEmptyInfo' do
    it 'should create an instance of MetaDescriptionEmptyInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaDescriptionEmptyInfo)
    end
  end
