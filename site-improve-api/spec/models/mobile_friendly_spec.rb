...
# Unit tests for OpenapiClient::MobileFriendly
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MobileFriendly do
  let(:instance) { OpenapiClient::MobileFriendly.new }

  describe 'test an instance of MobileFriendly' do
    it 'should create an instance of MobileFriendly' do
      expect(instance).to be_instance_of(OpenapiClient::MobileFriendly)
    end
  end
