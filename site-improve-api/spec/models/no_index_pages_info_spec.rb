...
# Unit tests for OpenapiClient::NoIndexPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NoIndexPagesInfo do
  let(:instance) { OpenapiClient::NoIndexPagesInfo.new }

  describe 'test an instance of NoIndexPagesInfo' do
    it 'should create an instance of NoIndexPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::NoIndexPagesInfo)
    end
  end
