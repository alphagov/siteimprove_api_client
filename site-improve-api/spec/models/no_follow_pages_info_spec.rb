...
# Unit tests for OpenapiClient::NoFollowPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NoFollowPagesInfo do
  let(:instance) { OpenapiClient::NoFollowPagesInfo.new }

  describe 'test an instance of NoFollowPagesInfo' do
    it 'should create an instance of NoFollowPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::NoFollowPagesInfo)
    end
  end
