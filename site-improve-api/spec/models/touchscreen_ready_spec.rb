...
# Unit tests for OpenapiClient::TouchscreenReady
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TouchscreenReady do
  let(:instance) { OpenapiClient::TouchscreenReady.new }

  describe 'test an instance of TouchscreenReady' do
    it 'should create an instance of TouchscreenReady' do
      expect(instance).to be_instance_of(OpenapiClient::TouchscreenReady)
    end
  end
