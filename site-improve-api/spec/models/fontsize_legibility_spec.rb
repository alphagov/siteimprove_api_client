...
# Unit tests for OpenapiClient::FontsizeLegibility
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FontsizeLegibility do
  let(:instance) { OpenapiClient::FontsizeLegibility.new }

  describe 'test an instance of FontsizeLegibility' do
    it 'should create an instance of FontsizeLegibility' do
      expect(instance).to be_instance_of(OpenapiClient::FontsizeLegibility)
    end
  end
