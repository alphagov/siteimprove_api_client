...
# Unit tests for OpenapiClient::SitemapExist
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SitemapExist do
  let(:instance) { OpenapiClient::SitemapExist.new }

  describe 'test an instance of SitemapExist' do
    it 'should create an instance of SitemapExist' do
      expect(instance).to be_instance_of(OpenapiClient::SitemapExist)
    end
  end
