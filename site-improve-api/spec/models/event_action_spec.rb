...
# Unit tests for OpenapiClient::EventAction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventAction do
  let(:instance) { OpenapiClient::EventAction.new }

  describe 'test an instance of EventAction' do
    it 'should create an instance of EventAction' do
      expect(instance).to be_instance_of(OpenapiClient::EventAction)
    end
  end
