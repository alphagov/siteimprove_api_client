...
# Unit tests for OpenapiClient::IgnoredIssues
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::IgnoredIssues do
  let(:instance) { OpenapiClient::IgnoredIssues.new }

  describe 'test an instance of IgnoredIssues' do
    it 'should create an instance of IgnoredIssues' do
      expect(instance).to be_instance_of(OpenapiClient::IgnoredIssues)
    end
  end
