...
# Unit tests for OpenapiClient::MetaTitleTooShortInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaTitleTooShortInfo do
  let(:instance) { OpenapiClient::MetaTitleTooShortInfo.new }

  describe 'test an instance of MetaTitleTooShortInfo' do
    it 'should create an instance of MetaTitleTooShortInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaTitleTooShortInfo)
    end
  end
