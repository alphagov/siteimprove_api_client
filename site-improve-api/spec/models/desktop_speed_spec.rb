...
# Unit tests for OpenapiClient::DesktopSpeed
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DesktopSpeed do
  let(:instance) { OpenapiClient::DesktopSpeed.new }

  describe 'test an instance of DesktopSpeed' do
    it 'should create an instance of DesktopSpeed' do
      expect(instance).to be_instance_of(OpenapiClient::DesktopSpeed)
    end
  end
