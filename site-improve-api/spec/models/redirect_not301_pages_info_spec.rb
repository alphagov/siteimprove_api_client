...
# Unit tests for OpenapiClient::RedirectNot301PagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RedirectNot301PagesInfo do
  let(:instance) { OpenapiClient::RedirectNot301PagesInfo.new }

  describe 'test an instance of RedirectNot301PagesInfo' do
    it 'should create an instance of RedirectNot301PagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::RedirectNot301PagesInfo)
    end
  end
