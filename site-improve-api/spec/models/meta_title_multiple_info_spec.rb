...
# Unit tests for OpenapiClient::MetaTitleMultipleInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaTitleMultipleInfo do
  let(:instance) { OpenapiClient::MetaTitleMultipleInfo.new }

  describe 'test an instance of MetaTitleMultipleInfo' do
    it 'should create an instance of MetaTitleMultipleInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaTitleMultipleInfo)
    end
  end
