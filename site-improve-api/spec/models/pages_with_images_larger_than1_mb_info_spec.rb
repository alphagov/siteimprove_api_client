...
# Unit tests for OpenapiClient::PagesWithImagesLargerThan1MbInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagesWithImagesLargerThan1MbInfo do
  let(:instance) { OpenapiClient::PagesWithImagesLargerThan1MbInfo.new }
  ...
  describe 'test an instance of PagesWithImagesLargerThan1MbInfo' do
    it 'should create an instance of PagesWithImagesLargerThan1MbInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PagesWithImagesLargerThan1MbInfo)
    end
  end
