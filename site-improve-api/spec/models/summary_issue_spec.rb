...
# Unit tests for OpenapiClient::SummaryIssue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SummaryIssue do
  let(:instance) { OpenapiClient::SummaryIssue.new }

  describe 'test an instance of SummaryIssue' do
    it 'should create an instance of SummaryIssue' do
      expect(instance).to be_instance_of(OpenapiClient::SummaryIssue)
    end
  end
