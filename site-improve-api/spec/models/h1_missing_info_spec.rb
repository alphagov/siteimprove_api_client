...
# Unit tests for OpenapiClient::H1MissingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::H1MissingInfo do
  let(:instance) { OpenapiClient::H1MissingInfo.new }

  describe 'test an instance of H1MissingInfo' do
    it 'should create an instance of H1MissingInfo' do
      expect(instance).to be_instance_of(OpenapiClient::H1MissingInfo)
    end
  end
