...
# Unit tests for OpenapiClient::MetaDescriptionMissingInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaDescriptionMissingInfo do
  let(:instance) { OpenapiClient::MetaDescriptionMissingInfo.new }

  describe 'test an instance of MetaDescriptionMissingInfo' do
    it 'should create an instance of MetaDescriptionMissingInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaDescriptionMissingInfo)
    end
  end
