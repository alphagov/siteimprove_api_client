...
# Unit tests for OpenapiClient::RobotsTxtExist
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RobotsTxtExist do
  let(:instance) { OpenapiClient::RobotsTxtExist.new }

  describe 'test an instance of RobotsTxtExist' do
    it 'should create an instance of RobotsTxtExist' do
      expect(instance).to be_instance_of(OpenapiClient::RobotsTxtExist)
    end
  end
