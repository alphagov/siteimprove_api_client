...
# Unit tests for OpenapiClient::UnsafeDomainsSeoInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UnsafeDomainsSeoInfo do
  let(:instance) { OpenapiClient::UnsafeDomainsSeoInfo.new }

  describe 'test an instance of UnsafeDomainsSeoInfo' do
    it 'should create an instance of UnsafeDomainsSeoInfo' do
      expect(instance).to be_instance_of(OpenapiClient::UnsafeDomainsSeoInfo)
    end
  end
