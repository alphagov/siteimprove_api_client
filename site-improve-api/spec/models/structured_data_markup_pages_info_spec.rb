...
# Unit tests for OpenapiClient::StructuredDataMarkupPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StructuredDataMarkupPagesInfo do
  let(:instance) { OpenapiClient::StructuredDataMarkupPagesInfo.new }
  ...
  describe 'test an instance of StructuredDataMarkupPagesInfo' do
    it 'should create an instance of StructuredDataMarkupPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::StructuredDataMarkupPagesInfo)
    end
  end
