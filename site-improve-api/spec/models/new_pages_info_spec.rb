...
# Unit tests for OpenapiClient::NewPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NewPagesInfo do
  let(:instance) { OpenapiClient::NewPagesInfo.new }

  describe 'test an instance of NewPagesInfo' do
    it 'should create an instance of NewPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::NewPagesInfo)
    end
  end
