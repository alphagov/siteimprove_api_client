...
# Unit tests for OpenapiClient::PagesWithParametersInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagesWithParametersInfo do
  let(:instance) { OpenapiClient::PagesWithParametersInfo.new }

  describe 'test an instance of PagesWithParametersInfo' do
    it 'should create an instance of PagesWithParametersInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PagesWithParametersInfo)
    end
  end
