...
# Unit tests for OpenapiClient::MetaTitleEmptyInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MetaTitleEmptyInfo do
  let(:instance) { OpenapiClient::MetaTitleEmptyInfo.new }

  describe 'test an instance of MetaTitleEmptyInfo' do
    it 'should create an instance of MetaTitleEmptyInfo' do
      expect(instance).to be_instance_of(OpenapiClient::MetaTitleEmptyInfo)
    end
  end
