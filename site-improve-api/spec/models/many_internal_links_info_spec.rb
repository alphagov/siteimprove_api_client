...
# Unit tests for OpenapiClient::ManyInternalLinksInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ManyInternalLinksInfo do
  let(:instance) { OpenapiClient::ManyInternalLinksInfo.new }

  describe 'test an instance of ManyInternalLinksInfo' do
    it 'should create an instance of ManyInternalLinksInfo' do
      expect(instance).to be_instance_of(OpenapiClient::ManyInternalLinksInfo)
    end
  end
