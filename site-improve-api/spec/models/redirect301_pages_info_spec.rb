...
# Unit tests for OpenapiClient::Redirect301PagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Redirect301PagesInfo do
  let(:instance) { OpenapiClient::Redirect301PagesInfo.new }

  describe 'test an instance of Redirect301PagesInfo' do
    it 'should create an instance of Redirect301PagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::Redirect301PagesInfo)
    end
  end
