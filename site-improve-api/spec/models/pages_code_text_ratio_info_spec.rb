...
# Unit tests for OpenapiClient::PagesCodeTextRatioInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagesCodeTextRatioInfo do
  let(:instance) { OpenapiClient::PagesCodeTextRatioInfo.new }

  describe 'test an instance of PagesCodeTextRatioInfo' do
    it 'should create an instance of PagesCodeTextRatioInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PagesCodeTextRatioInfo)
    end
  end
