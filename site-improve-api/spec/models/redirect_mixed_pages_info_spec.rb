...
# Unit tests for OpenapiClient::RedirectMixedPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RedirectMixedPagesInfo do
  let(:instance) { OpenapiClient::RedirectMixedPagesInfo.new }

  describe 'test an instance of RedirectMixedPagesInfo' do
    it 'should create an instance of RedirectMixedPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::RedirectMixedPagesInfo)
    end
  end
