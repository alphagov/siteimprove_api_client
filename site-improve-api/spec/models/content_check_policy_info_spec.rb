...
# Unit tests for OpenapiClient::ContentCheckPolicyInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ContentCheckPolicyInfo do
  let(:instance) { OpenapiClient::ContentCheckPolicyInfo.new }

  describe 'test an instance of ContentCheckPolicyInfo' do
    it 'should create an instance of ContentCheckPolicyInfo' do
      expect(instance).to be_instance_of(OpenapiClient::ContentCheckPolicyInfo)
    end
  end
