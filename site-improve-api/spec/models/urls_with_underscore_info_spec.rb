...
# Unit tests for OpenapiClient::UrlsWithUnderscoreInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UrlsWithUnderscoreInfo do
  let(:instance) { OpenapiClient::UrlsWithUnderscoreInfo.new }

  describe 'test an instance of UrlsWithUnderscoreInfo' do
    it 'should create an instance of UrlsWithUnderscoreInfo' do
      expect(instance).to be_instance_of(OpenapiClient::UrlsWithUnderscoreInfo)
    end
  end
