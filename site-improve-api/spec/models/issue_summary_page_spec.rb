...
# Unit tests for OpenapiClient::IssueSummaryPage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::IssueSummaryPage do
  let(:instance) { OpenapiClient::IssueSummaryPage.new }

  describe 'test an instance of IssueSummaryPage' do
    it 'should create an instance of IssueSummaryPage' do
      expect(instance).to be_instance_of(OpenapiClient::IssueSummaryPage)
    end
  end
