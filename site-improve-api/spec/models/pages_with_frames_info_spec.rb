...
# Unit tests for OpenapiClient::PagesWithFramesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagesWithFramesInfo do
  let(:instance) { OpenapiClient::PagesWithFramesInfo.new }

  describe 'test an instance of PagesWithFramesInfo' do
    it 'should create an instance of PagesWithFramesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PagesWithFramesInfo)
    end
  end
