...
# Unit tests for OpenapiClient::PolicyInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PolicyInfo do
  let(:instance) { OpenapiClient::PolicyInfo.new }

  describe 'test an instance of PolicyInfo' do
    it 'should create an instance of PolicyInfo' do
      expect(instance).to be_instance_of(OpenapiClient::PolicyInfo)
    end
  end
