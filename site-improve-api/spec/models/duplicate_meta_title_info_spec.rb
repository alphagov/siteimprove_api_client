...
# Unit tests for OpenapiClient::DuplicateMetaTitleInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DuplicateMetaTitleInfo do
  let(:instance) { OpenapiClient::DuplicateMetaTitleInfo.new }

  describe 'test an instance of DuplicateMetaTitleInfo' do
    it 'should create an instance of DuplicateMetaTitleInfo' do
      expect(instance).to be_instance_of(OpenapiClient::DuplicateMetaTitleInfo)
    end
  end
