...
# Unit tests for OpenapiClient::LinksStatusCode404Info
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LinksStatusCode404Info do
  let(:instance) { OpenapiClient::LinksStatusCode404Info.new }

  describe 'test an instance of LinksStatusCode404Info' do
    it 'should create an instance of LinksStatusCode404Info' do
      expect(instance).to be_instance_of(OpenapiClient::LinksStatusCode404Info)
    end
  end
