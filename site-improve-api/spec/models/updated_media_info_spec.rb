...
# Unit tests for OpenapiClient::UpdatedMediaInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdatedMediaInfo do
  let(:instance) { OpenapiClient::UpdatedMediaInfo.new }

  describe 'test an instance of UpdatedMediaInfo' do
    it 'should create an instance of UpdatedMediaInfo' do
      expect(instance).to be_instance_of(OpenapiClient::UpdatedMediaInfo)
    end
  end
