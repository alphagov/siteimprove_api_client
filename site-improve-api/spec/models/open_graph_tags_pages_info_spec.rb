...
# Unit tests for OpenapiClient::OpenGraphTagsPagesInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OpenGraphTagsPagesInfo do
  let(:instance) { OpenapiClient::OpenGraphTagsPagesInfo.new }

  describe 'test an instance of OpenGraphTagsPagesInfo' do
    it 'should create an instance of OpenGraphTagsPagesInfo' do
      expect(instance).to be_instance_of(OpenapiClient::OpenGraphTagsPagesInfo)
    end
  end
