  ...
  class OpenGraphTagsPage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::OpenGraphTagsPage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::OpenGraphTagsPage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tags_on_page')
        self.tags_on_page = attributes[:'tags_on_page']
      else
        self.tags_on_page = nil
      end
    ...
    def list_invalid_properties
      ...
      if @tags_on_page.nil?
        invalid_properties.push('invalid value for "tags_on_page", tags_on_page cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tags_on_page.nil?
      true
    end
    ...
    def hash
      [id, title, url, checking_now, cms_url, page_level, page_views, tags_on_page, _siteimprove].hash
    end
