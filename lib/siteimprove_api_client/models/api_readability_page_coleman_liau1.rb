...
module SiteimproveAPIClient
  class ApiReadabilityPageColemanLiau1
    # Id of page.
    attr_accessor :id
    ...
    # Coleman Liau index is calculated using: 0.0588*average_chars_with_digits - 0.296*average_sentences_w_digits - 15.8
    attr_accessor :coleman_liau_score
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::ApiReadabilityPageColemanLiau1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::ApiReadabilityPageColemanLiau1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'coleman_liau_score')
        self.coleman_liau_score = attributes[:'coleman_liau_score']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cms_url == o.cms_url &&
          coleman_liau_score == o.coleman_liau_score &&
    ...
    def hash
      [id, title, url, average_chars_with_digits, average_sentences_with_digits, checking_now, cms_url, coleman_liau_score, long_sentences_with_digits_unique, long_words_with_digits_unique, page_level, page_views, _siteimprove].hash
    end
