...
module SiteimproveAPIClient
  class SslMixedContentPage
    ...
    # The number of http links on the page
    attr_accessor :http_links
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::SslMixedContentPage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::SslMixedContentPage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'http_links')
        self.http_links = attributes[:'http_links']
      else
        self.http_links = nil
      end
    ...
    def list_invalid_properties
      ...
      if @http_links.nil?
        invalid_properties.push('invalid value for "http_links", http_links cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @http_links.nil?
      true
    end
    ...
    def hash
      [id, title, url, checking_now, cms_url, http_links, page_level, page_views, _siteimprove].hash
    end
