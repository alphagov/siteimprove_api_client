...
module SiteimproveAPIClient
  class ReferringPageForPage
    ...
    # If this page is member of the group (supplied via group_id).
    attr_accessor :member_of_this_group
    ...
    def self.attribute_map
      {
        ...
        :'cms_url' => :'cms_url',
        :'member_of_this_group' => :'member_of_this_group',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::ReferringPageForPage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::ReferringPageForPage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'member_of_this_group')
        self.member_of_this_group = attributes[:'member_of_this_group']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cms_url == o.cms_url &&
          member_of_this_group == o.member_of_this_group &&
    ...
    def hash
      [id, title, url, checking_now, cms_url, member_of_this_group, page_level, page_score, page_views, _siteimprove].hash
    end
