...
module SiteimproveAPIClient
  class PopularPage
    ...
    attr_accessor :average_page_views_per_visit
    ...
    # Last time the page was visited. Timestamp represented using ISO-8601
    ...
    def self.attribute_map
      {
        ...
        :'title' => :'title',
        :'url' => :'url',
        :'average_page_views_per_visit' => :'average_page_views_per_visit',
    ...
    def self.openapi_types
      {
        ...
        :'title' => :'String',
        :'url' => :'String',
        :'average_page_views_per_visit' => :'Float',
        :'bounce_rate' => :'Float',
        :'cms_url' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::PopularPage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::PopularPage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'average_page_views_per_visit')
        self.average_page_views_per_visit = attributes[:'average_page_views_per_visit']
      end
      ...
      if attributes.key?(:'last_visited')
        self.last_visited = attributes[:'last_visited']
      else
        self.last_visited = nil
      end
    ...
    def list_invalid_properties
      ...
      if @last_visited.nil?
        invalid_properties.push('invalid value for "last_visited", last_visited cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @last_visited.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          title == o.title &&
          url == o.url &&
          average_page_views_per_visit == o.average_page_views_per_visit &&
    ...
    def hash
      [id, title, url, average_page_views_per_visit, bounce_rate, cms_url, has_integration, last_visited, page_level, page_score, page_views, rank, visits, _siteimprove].hash
    end
