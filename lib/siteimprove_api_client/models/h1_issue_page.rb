...
module SiteimproveAPIClient
  class H1IssuePage
    ...
    # The number of empty H1s
    attr_accessor :empty_h1s
    ...
    # The total number of H1s found on the page
    attr_accessor :total_h1s
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::H1IssuePage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::H1IssuePage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'empty_h1s')
        self.empty_h1s = attributes[:'empty_h1s']
      else
        self.empty_h1s = nil
      end
      ...
      if attributes.key?(:'total_h1s')
        self.total_h1s = attributes[:'total_h1s']
      else
        self.total_h1s = nil
      end
    ...
    def list_invalid_properties
      ...
      if @empty_h1s.nil?
        invalid_properties.push('invalid value for "empty_h1s", empty_h1s cannot be nil.')
      end

      if @total_h1s.nil?
        invalid_properties.push('invalid value for "total_h1s", total_h1s cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @empty_h1s.nil?
      return false if @total_h1s.nil?
      true
    end
    ...
    def hash
      [id, title, url, checking_now, cms_url, empty_h1s, page_level, page_views, total_h1s, _siteimprove].hash
    end
