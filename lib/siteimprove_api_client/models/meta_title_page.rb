...
module SiteimproveAPIClient
  class MetaTitlePage
    ...
    # The length of the meta title
    attr_accessor :meta_title_length

    # Is true if the meta title is missing; otherwise false
    attr_accessor :meta_title_missing
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::MetaTitlePage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::MetaTitlePage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'meta_title_length')
        self.meta_title_length = attributes[:'meta_title_length']
      else
        self.meta_title_length = nil
      end

      if attributes.key?(:'meta_title_missing')
        self.meta_title_missing = attributes[:'meta_title_missing']
      else
        self.meta_title_missing = nil
      end
    ...
    def list_invalid_properties
      ...
      if @meta_title_length.nil?
        invalid_properties.push('invalid value for "meta_title_length", meta_title_length cannot be nil.')
      end

      if @meta_title_missing.nil?
        invalid_properties.push('invalid value for "meta_title_missing", meta_title_missing cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @meta_title_length.nil?
      return false if @meta_title_missing.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          meta_title_length == o.meta_title_length &&
          meta_title_missing == o.meta_title_missing &&
    ...
    def hash
      [id, title, url, checking_now, cms_url, meta_title, meta_title_length, meta_title_missing, page_level, page_views, _siteimprove].hash
    end
