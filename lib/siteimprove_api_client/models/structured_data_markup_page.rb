...
module SiteimproveAPIClient
  class StructuredDataMarkupPage
    # The id of the page
    attr_accessor :id
    ...
    # The number of elements with schema
    attr_accessor :elements_with_schema
    ...
    def self.attribute_map
      {
        ...
        :'cms_url' => :'cms_url',
        :'elements_with_schema' => :'elements_with_schema',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::StructuredDataMarkupPage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::StructuredDataMarkupPage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'elements_with_schema')
        self.elements_with_schema = attributes[:'elements_with_schema']
      else
        self.elements_with_schema = nil
      end
    ...
    def list_invalid_properties
      ...
      if @elements_with_schema.nil?
        invalid_properties.push('invalid value for "elements_with_schema", elements_with_schema cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @elements_with_schema.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cms_url == o.cms_url &&
          elements_with_schema == o.elements_with_schema &&
    ...
    def hash
      [id, title, url, checking_now, cms_url, elements_with_schema, page_level, page_views, _siteimprove].hash
    end
