...
module SiteimproveAPIClient
  class ApiReadabilityPageLix1
    ...
    # LIX \"läsbarhetsindex\" is calculated using: words/sentences + (long_words*100)/words
    attr_accessor :lix_score

    # Number of unique long sentences.
    attr_accessor :long_sentences_unique

    # Number of long words.
    attr_accessor :long_words
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::ApiReadabilityPageLix1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::ApiReadabilityPageLix1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lix_score')
        self.lix_score = attributes[:'lix_score']
      end
      ...
      if attributes.key?(:'long_words')
        self.long_words = attributes[:'long_words']
      else
        self.long_words = nil
      end
    ...
    def list_invalid_properties
      ...
      if @long_words.nil?
        invalid_properties.push('invalid value for "long_words", long_words cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @long_words.nil?
    ...
    def hash
      [id, title, url, checking_now, cms_url, lix_score, long_sentences_unique, long_words, long_words_unique, page_level, page_views, sentences, words, _siteimprove].hash
    end
