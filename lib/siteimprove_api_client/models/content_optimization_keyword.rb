...
module SiteimproveAPIClient
  class ContentOptimizationKeyword
    # The id of the keyword
    attr_accessor :id

    # The title of the target page for this keyword
    attr_accessor :title

    # Is true if page is being checked now; otherwise false
    attr_accessor :checking_now

    # The number of content issues for the keyword and target page combination
    attr_accessor :content_issues

    # The database for the keyword
    attr_accessor :database

    # The progress for this keyword and target page combination
    attr_accessor :issue_progress

    # The number of keyword issues for the keyword and target page combination
    attr_accessor :keyword_issues

    # The page id of the target page
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::ContentOptimizationKeyword` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::ContentOptimizationKeyword`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'issue_progress')
        self.issue_progress = attributes[:'issue_progress']
      end

      if attributes.key?(:'keyword_issues')
        self.keyword_issues = attributes[:'keyword_issues']
      else
        self.keyword_issues = nil
      end
    ...
    def list_invalid_properties
      ...
      if @keyword_issues.nil?
        invalid_properties.push('invalid value for "keyword_issues", keyword_issues cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @keyword_issues.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          database == o.database &&
          issue_progress == o.issue_progress &&
          keyword_issues == o.keyword_issues &&
          page_id == o.page_id &&
    ...
    def hash
      [id, title, checking_now, content_issues, database, issue_progress, keyword_issues, page_id, search_volume, target_url, _links].hash
    end
