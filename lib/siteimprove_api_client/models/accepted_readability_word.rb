...
module SiteimproveAPIClient
  class AcceptedReadabilityWord
    # Id of the accepted word.
    attr_accessor :id

    # The accepted word
    attr_accessor :accepted_word

    # The name of the person creating this decision.
    attr_accessor :created_by

    # Timestamp for when the decision for this word was created.
    attr_accessor :created_time

    # If this decision applies for all sites
    attr_accessor :is_global

    # Id for the person creating this decision.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::AcceptedReadabilityWord` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::AcceptedReadabilityWord`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'accepted_word')
        self.accepted_word = attributes[:'accepted_word']
      end
    ...
    def hash
      [id, accepted_word, created_by, created_time, is_global, person_id, _siteimprove].hash
    end
