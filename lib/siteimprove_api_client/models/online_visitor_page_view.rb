...
module SiteimproveAPIClient
  class OnlineVisitorPageView
    ...
    # When the page was viewed the last time by the user.
    attr_accessor :last_page_view
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::OnlineVisitorPageView` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::OnlineVisitorPageView`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_page_view')
        self.last_page_view = attributes[:'last_page_view']
      else
        self.last_page_view = nil
      end
    ...
    def list_invalid_properties
      ...
      if @last_page_view.nil?
        invalid_properties.push('invalid value for "last_page_view", last_page_view cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @last_page_view.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_page_view == o.last_page_view &&
    ...
    def hash
      [id, title, url, cms_url, has_integration, last_page_view, _siteimprove].hash
    end
