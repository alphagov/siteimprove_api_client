...
module SiteimproveAPIClient
  class AccessibilityGroupsOverview
    # Internal group id
    attr_accessor :id

    # Number of A issues for the pages handled by this group
    attr_accessor :a_issues

    # Number of AA issues for the pages handled by this group
    attr_accessor :aa_issues

    # Number of AAA issues for the pages handled by this group
    attr_accessor :aaa_issues

    # Name of the group
    attr_accessor :group_name

    # Number of pages handled by the group
    attr_accessor :pages

    # Number of pages with PDF Issues for pages handled by this group
    attr_accessor :pdf_issues

    # Number of users with access to this group
    attr_accessor :users
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::AccessibilityGroupsOverview` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::AccessibilityGroupsOverview`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, a_issues, aa_issues, aaa_issues, group_name, pages, pdf_issues, users, _links, _siteimprove].hash
    end
