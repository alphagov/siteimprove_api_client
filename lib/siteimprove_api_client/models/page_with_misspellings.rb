  ...
  class PageWithMisspellings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::PageWithMisspellings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::PageWithMisspellings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'potential_misspellings')
        ...
        self.potential_misspellings = nil
      end
    ...
    def list_invalid_properties
      ...
      if @potential_misspellings.nil?
        invalid_properties.push('invalid value for "potential_misspellings", potential_misspellings cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @potential_misspellings.nil?
      true
    end
    ...
    def hash
      [id, title, url, checking_now, cms_url, misspellings, page_level, page_views, potential_misspellings, _links, _siteimprove].hash
    end
