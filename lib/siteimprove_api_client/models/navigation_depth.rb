  ...
  class NavigationDepth
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::NavigationDepth` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::NavigationDepth`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'average_clicks')
        self.average_clicks = attributes[:'average_clicks']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          title == o.title &&
          url == o.url &&
          average_clicks == o.average_clicks &&
          cms_url == o.cms_url &&
    ...
    def hash
      [id, title, url, average_clicks, cms_url, has_integration, page_level, page_score, page_views, visits, _siteimprove].hash
    end
