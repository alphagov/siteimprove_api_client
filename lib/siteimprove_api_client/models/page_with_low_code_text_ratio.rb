...
module SiteimproveAPIClient
  class PageWithLowCodeTextRatio
    # The id of the page
    attr_accessor :id
    ...
    def self.attribute_map
      {
        ...
        :'cms_url' => :'cms_url',
        :'code_text_ratio' => :'code_text_ratio',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::PageWithLowCodeTextRatio` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::PageWithLowCodeTextRatio`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'code_text_ratio')
        self.code_text_ratio = attributes[:'code_text_ratio']
      else
        self.code_text_ratio = nil
      end
    ...
    def list_invalid_properties
      ...
      if @code_text_ratio.nil?
        invalid_properties.push('invalid value for "code_text_ratio", code_text_ratio cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @code_text_ratio.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cms_url == o.cms_url &&
          code_text_ratio == o.code_text_ratio &&
    ...
    def hash
      [id, title, url, checking_now, cms_url, code_text_ratio, page_level, page_views, _siteimprove].hash
    end
