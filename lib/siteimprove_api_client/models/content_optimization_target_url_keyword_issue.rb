...
module SiteimproveAPIClient
  class ContentOptimizationTargetUrlKeywordIssue
    # The database for the keyword
    attr_accessor :database

    # True if the keyword was expected in the element; otherwise false
    attr_accessor :expected_in_element

    # The type of keyword issue
    attr_accessor :issue_type

    # The keyword causing the issue
    ...
    def self.attribute_map
      {
        :'database' => :'database',
        :'expected_in_element' => :'expected_in_element',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::ContentOptimizationTargetUrlKeywordIssue` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::ContentOptimizationTargetUrlKeywordIssue`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expected_in_element')
        self.expected_in_element = attributes[:'expected_in_element']
      else
        self.expected_in_element = nil
      end
    ...
    def list_invalid_properties
      ...
      if @expected_in_element.nil?
        invalid_properties.push('invalid value for "expected_in_element", expected_in_element cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @expected_in_element.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          database == o.database &&
          expected_in_element == o.expected_in_element &&
    ...
    def hash
      [database, expected_in_element, issue_type, keyword, occurrences].hash
    end
