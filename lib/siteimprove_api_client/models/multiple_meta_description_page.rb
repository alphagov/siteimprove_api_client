...
module SiteimproveAPIClient
  class MultipleMetaDescriptionPage
    # The id of page
    attr_accessor :id
    ...
    # The number of meta descriptions found on the page
    attr_accessor :meta_descriptions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::MultipleMetaDescriptionPage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::MultipleMetaDescriptionPage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'meta_descriptions')
        self.meta_descriptions = attributes[:'meta_descriptions']
      else
        self.meta_descriptions = nil
      end
    ...
    def list_invalid_properties
      ...
      if @meta_descriptions.nil?
        invalid_properties.push('invalid value for "meta_descriptions", meta_descriptions cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @meta_descriptions.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cms_url == o.cms_url &&
          meta_descriptions == o.meta_descriptions &&
    ...
    def hash
      [id, title, url, checking_now, cms_url, meta_descriptions, page_level, page_views, _siteimprove].hash
    end
