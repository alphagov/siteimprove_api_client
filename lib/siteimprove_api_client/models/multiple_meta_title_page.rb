...
module SiteimproveAPIClient
  class MultipleMetaTitlePage
    ...
    # The number of meta titles found on the page
    attr_accessor :meta_titles
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::MultipleMetaTitlePage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::MultipleMetaTitlePage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'meta_titles')
        self.meta_titles = attributes[:'meta_titles']
      else
        self.meta_titles = nil
      end
    ...
    def list_invalid_properties
      ...
      if @meta_titles.nil?
        invalid_properties.push('invalid value for "meta_titles", meta_titles cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @meta_titles.nil?
      true
    end
    ...
    def hash
      [id, title, url, checking_now, cms_url, meta_titles, page_level, page_views, _siteimprove].hash
    end
