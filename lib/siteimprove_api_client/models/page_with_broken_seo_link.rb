...
module SiteimproveAPIClient
  class PageWithBrokenSeoLink
    ...
    # The number of clicks registered on the link(s)
    attr_accessor :unsuccessful_clicks
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::PageWithBrokenSeoLink` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::PageWithBrokenSeoLink`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unsuccessful_clicks')
        self.unsuccessful_clicks = attributes[:'unsuccessful_clicks']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          unsuccessful_clicks == o.unsuccessful_clicks &&
    ...
    def hash
      [id, title, url, checking_now, cms_url, page_level, page_views, unsuccessful_clicks, _siteimprove].hash
    end
