  ...
  class PageWithLongUrl
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::PageWithLongUrl` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::PageWithLongUrl`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'url_length')
        self.url_length = attributes[:'url_length']
      else
        self.url_length = nil
      end
    ...
    def list_invalid_properties
      ...
      if @url_length.nil?
        invalid_properties.push('invalid value for "url_length", url_length cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @url_length.nil?
      true
    end
    ...
    def hash
      [id, title, url, checking_now, cms_url, page_level, page_views, url_length, _siteimprove].hash
    end
