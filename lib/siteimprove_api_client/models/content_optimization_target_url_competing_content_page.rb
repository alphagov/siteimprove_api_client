...
module SiteimproveAPIClient
  class ContentOptimizationTargetUrlCompetingContentPage
    # The id of the competing content page
    attr_accessor :id

    # Title of the page
    attr_accessor :title

    # The URL of the competing content page
    attr_accessor :url

    # Is true if the page is checking now; otherwise false
    attr_accessor :checking_now

    # Url for the cms entry for editing the page.
    attr_accessor :cms_url

    # The number of occurrences of the keyword on the page with the competing content type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SiteimproveAPIClient::ContentOptimizationTargetUrlCompetingContentPage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SiteimproveAPIClient::ContentOptimizationTargetUrlCompetingContentPage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, title, url, checking_now, cms_url, occurrences, page_level, page_views, _siteimprove].hash
    end
